...
const AddDecorate = () => {
  ...
  const handleChange = (e) => {
    ...
    setdecorate({ ...decorate, [name]: value })
    // console.log(e.targert.value);
  }
  const postData = async (e) => {
    e.preventDefault();
    const { p_img, p_name, city, rating, review, price } = decorate;
    ...
    const res = await fetch("/adddecorate", {
      method: "POST",
      body: form_data
    })
    ...
    <>
      ...
      <div className="d-flex">
        ...
        <form className="col-10 mt-3 px-3">
          ...
          <h2 align="center" className='bg-danger text-white' >Add Decorate plans</h2>
          </div>
