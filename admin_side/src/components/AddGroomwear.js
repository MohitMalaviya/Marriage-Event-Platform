...
const AddGroomwear = () => {
  ...
  const handleChange = (e) => {
    ...
    setgroomwear({ ...groomwear, [name]: value })
    // console.log(e.targert.value);
  }
  const postData = async (e) => {
    e.preventDefault();
    const { p_img, p_name, city, rating, review, price } = groomwear;
    ...
    const res = await fetch("/addgroomwear", {
      method: "POST",
      body: form_data
    })
    ...
    <>
      ...
      <div className="d-flex">
        ...
        <form className="col-10 mt-3 px-3">
          ...
          <h2 align="center" className='bg-danger text-white' >Add  groomwear </h2>
          </div>
