...
const UpdateBrideWear = () => {
    ...
    const postData = async (e) => {
        e.preventDefault();
        const { p_img, p_name, city, rating, review, price,designerby } = state;
        ...
        const res = await fetch("/updatebridewear", {
            method: "POST",
            headers: {},
            body: form_data
        })
...
export default UpdateBrideWear
