...
const Decoratshop = () => {
  ...
  const getData = async () => {
    const res = await fetch("/getdecoratebyid", {
      method: "POST",
      headers: {
          ...
          <div className="row">
            <div className="col-6 me-0 ">
              <img
                src={data?.p_img}
                alt=""
                className="ms-24 w-[700px] h-[470px] brideshop rounded-lg"
              />
            </div>
            ...
            <div className="col-6 ">
              ...
              >
                <div className="d-flex justify-content-between align-items-center mt-4">
                  <Card.Title className="ms-4 fs-4"> {data?.p_name}</Card.Title>
                ...
                <Card.Text className=" ms-4 text-muted -mt-2">
                  Standard Decor Price (See Full Pricelist)
                </Card.Text>
                ...
                <div className="d-flex justify-content-center align-items-center">
                  <button
                    className=" h-12 w-36 fs-6 text-white font-bold rounded-3xl get_quotation"
                    onClick={() => {
                      navigate("/Decorateform");
                    }}
                  >
                    ₹ Get Quotation
                  </button>
