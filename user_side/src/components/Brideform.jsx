...
const Brideform = () => {
  ...
  useEffect(() => {
    ...
    console.log(a);
    const mydata = bridedata.filter((val) => {
      return val.id == a;
    });
    setdata(mydata);
  }, []);
        ...
        <div className="mthome">
          <div className="row">
            ...
            <div className="col-6 shadow-lg mt-4 rounded-xl">
              <h3 className="d-flex justify-center mt-8 -ml-32 text-pink-800">
                As You Wish Wedding wear Rentals
              </h3>
              ...
              <select
                name=""
                id=""
                className="select_decorate mt-4 text-gray-400"
              >
              ...
              <div className="d-flex justify-content-center align-items-center mt-4">
                <button
                  className=" h-12 w-56 fs-6 -ml-28 text-white font-bold rounded-3xl get_quotation mb-4"
                  onClick={() => {
                    navigate("/Payment");
                  }}
                >
